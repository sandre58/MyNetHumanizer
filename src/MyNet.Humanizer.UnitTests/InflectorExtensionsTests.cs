...
namespace MyNet.Humanizer.UnitTests
{
    ...
    internal class EnglishPluralTestSource : IEnumerable<object[]>
    {
    ...
    internal class FrenchPluralTestSource : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[] { "catégorie", "catégories" };
            yield return new object[] { "bateau", "bateaux" };
            yield return new object[] { "noyau", "noyaux" };
            yield return new object[] { "animal", "animaux" };
            yield return new object[] { "carnaval", "carnavals" };
            yield return new object[] { "portail", "portails" };
            yield return new object[] { "bail", "baux" };
            yield return new object[] { "genou", "genoux" };
            yield return new object[] { "cou", "cous" };
        }
